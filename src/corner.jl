function imcorner(img::AbstractArray, method::AbstractString="harris", border::AbstractString="replicate", blockSize::Int=5, k::Float64=0.04)
	...
	box_filter_kernel = ones(blockSize,blockSize);
